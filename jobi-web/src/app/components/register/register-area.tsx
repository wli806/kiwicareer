...
const RegisterArea = () => {
  const createAccountText = useLocalizedContent("Create Account", "创建账户");
  const haveAccountText = useLocalizedContent("Have an account?", "已有账户？");
  const signInText = useLocalizedContent("Sign In", "登录");
